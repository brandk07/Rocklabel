"""Command line for the alternative SLAM.
    ...
    python -m altslam recordings/VolleyBallTest*.mcap --suffix .reslam
    python -m altslam recordings/VolleyBallTest1.mcap --score-only
"""
...
from altslam.reprocess import reprocess


def build_parser() -> argparse.ArgumentParser:
    p = argparse.ArgumentParser(
        prog="python -m altslam",
