...
Run with:  pytest altslam/tests -q
"""
...
from altslam.evaluate import accumulate, detilt_rotation, surface_sharpness
from altslam.register import _normal_balance_weights, register, so3_exp
from altslam.solver import OfflineSolver, _slerp
from altslam.voxelmap import NormalVoxelMap, voxel_downsample
...
def test_reprocess_writes_a_readable_copy_and_leaves_the_source_alone(tmp_path):
    from altslam.reprocess import load_frames, reprocess, write_frames
...
def test_reprocess_rejects_an_empty_recording(tmp_path):
    from altslam.reprocess import reprocess, write_frames
...
def test_cli_output_naming():
    from altslam.cli import build_parser, config_from_args, output_path
...
def test_cli_flags_reach_the_config():
    from altslam.cli import build_parser, config_from_args
