...
| model 2 | classify | 0.725 | `/home/brandon/Documents/perception-2026-testing/rocklabel/training/experiments/lance-campaign-v1/pointnet-matched/seed-42/pointnet_loro_VolleyBallTest3.reslam_dx-dy-dz/best.pt` |

| rock | intervals | visible returns | model 1 median / best / detected | model 2 median / best / detected | 
|---:|---:|---:|---:|---:|
| 1 | 3 | 165 | 78% / 80% / 3/3 | 67% / 73% / 3/3 | 
| 3 | 3 | 470 | 84% / 91% / 3/3 | 81% / 82% / 3/3 | 
| 4 | 3 | 1158 | 54% / 67% / 2/3 | 46% / 64% / 3/3 | 
| 5 | 2 | 1006 | 83% / 94% / 2/2 | 83% / 94% / 2/2 | 
| 9 | 3 | 439 | 89% / 91% / 3/3 | 82% / 94% / 3/3 | 
| 10 | 2 | 182 | 76% / 89% / 2/2 | 70% / 78% / 2/2 | 
| 11 | 2 | 396 | 66% / 67% / 2/2 | 63% / 67% / 2/2 | 
| 12 | 2 | 362 | 73% / 100% / 2/2 | 64% / 75% / 2/2 | 
| 13 | 3 | 298 | 54% / 59% / 2/3 | 38% / 53% / 2/3 | 
...
- Median clear-region positive cells per interval: model 1 `84.0`, model 2 `83.0`
...
- [Rock 12 · interval 2](cases/rock-012-interval-0002.png)
