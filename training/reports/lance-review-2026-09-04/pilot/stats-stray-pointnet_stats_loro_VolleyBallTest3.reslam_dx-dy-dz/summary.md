...
| model 2 | classify | 0.721 | `/home/brandon/Documents/perception-2026-testing/rocklabel/training/experiments/lance-campaign-v1/stats-stray/seed-42/pointnet_stats_loro_VolleyBallTest3.reslam_dx-dy-dz/best.pt` |

| rock | intervals | visible returns | model 1 median / best / detected | model 2 median / best / detected | 
|---:|---:|---:|---:|---:|
| 1 | 3 | 165 | 78% / 80% / 3/3 | 73% / 78% / 2/3 | 
| 3 | 3 | 470 | 84% / 91% / 3/3 | 94% / 95% / 3/3 | 
| 4 | 3 | 1158 | 54% / 67% / 2/3 | 69% / 74% / 3/3 | 
| 5 | 2 | 1006 | 83% / 94% / 2/2 | 89% / 94% / 2/2 | 
| 9 | 3 | 439 | 89% / 91% / 3/3 | 81% / 94% / 3/3 | 
| 10 | 2 | 182 | 76% / 89% / 2/2 | 71% / 75% / 2/2 | 
| 11 | 2 | 396 | 66% / 67% / 2/2 | 69% / 71% / 2/2 | 
| 12 | 2 | 362 | 73% / 100% / 2/2 | 87% / 100% / 2/2 | 
| 13 | 3 | 298 | 54% / 59% / 2/3 | 59% / 85% / 2/3 | 
...
- Median clear-region positive cells per interval: model 1 `84.0`, model 2 `184.0`
