...
| model 2 | classify | 0.737 | `/home/brandon/Documents/perception-2026-testing/rocklabel/training/experiments/lance-campaign-v1/pointnet-stray/seed-42/pointnet_loro_VolleyBallTest3.reslam_dx-dy-dz/best.pt` |

| rock | intervals | visible returns | model 1 median / best / detected | model 2 median / best / detected | 
|---:|---:|---:|---:|---:|
| 1 | 3 | 165 | 78% / 80% / 3/3 | 67% / 73% / 3/3 | 
| 3 | 3 | 470 | 84% / 91% / 3/3 | 88% / 91% / 3/3 | 
| 4 | 3 | 1158 | 54% / 67% / 2/3 | 64% / 71% / 2/3 | 
| 5 | 2 | 1006 | 83% / 94% / 2/2 | 83% / 94% / 2/2 | 
| 9 | 3 | 439 | 89% / 91% / 3/3 | 82% / 94% / 3/3 | 
| 10 | 2 | 182 | 76% / 89% / 2/2 | 70% / 78% / 2/2 | 
| 11 | 2 | 396 | 66% / 67% / 2/2 | 60% / 67% / 2/2 | 
| 12 | 2 | 362 | 73% / 100% / 2/2 | 77% / 100% / 2/2 | 
| 13 | 3 | 298 | 54% / 59% / 2/3 | 54% / 59% / 2/3 | 
...
- Median clear-region positive cells per interval: model 1 `84.0`, model 2 `104.0`
...
- [Rock 3 · interval 30](cases/rock-003-interval-0030.png)
- [Rock 5 · interval 2](cases/rock-005-interval-0002.png)
- [Rock 13 · interval 49](cases/rock-013-interval-0049.png)
