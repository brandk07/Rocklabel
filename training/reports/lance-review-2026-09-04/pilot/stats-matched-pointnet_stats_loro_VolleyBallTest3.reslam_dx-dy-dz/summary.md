...
| model 2 | classify | 0.716 | `/home/brandon/Documents/perception-2026-testing/rocklabel/training/experiments/lance-campaign-v1/stats-matched/seed-42/pointnet_stats_loro_VolleyBallTest3.reslam_dx-dy-dz/best.pt` |

| rock | intervals | visible returns | model 1 median / best / detected | model 2 median / best / detected | 
|---:|---:|---:|---:|---:|
| 1 | 3 | 165 | 78% / 80% / 3/3 | 61% / 64% / 2/3 | 
| 3 | 3 | 470 | 84% / 91% / 3/3 | 75% / 76% / 3/3 | 
| 4 | 3 | 1158 | 54% / 67% / 2/3 | 67% / 74% / 2/3 | 
| 5 | 2 | 1006 | 83% / 94% / 2/2 | 87% / 94% / 2/2 | 
| 9 | 3 | 439 | 89% / 91% / 3/3 | 73% / 78% / 3/3 | 
| 10 | 2 | 182 | 76% / 89% / 2/2 | 64% / 78% / 2/2 | 
| 11 | 2 | 396 | 66% / 67% / 2/2 | 66% / 67% / 2/2 | 
...
A material difference was fixed at **20% median rock coverage** before inspecting the selected images. Model 1 leads on 1/9 distinct rocks; model 2 leads on 0/9; 8/9 are within the gap.

- Model 1 coverage leads: `[13]`
- Model 2 coverage leads: `none`
- Model 1 persistent detection-only rocks: `none`
- Model 2 persistent detection-only rocks: `none`
- Median clear-region positive cells per interval: model 1 `84.0`, model 2 `122.0`
