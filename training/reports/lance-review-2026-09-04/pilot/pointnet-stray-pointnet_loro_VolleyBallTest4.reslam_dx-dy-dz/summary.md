...
| model 2 | classify | 0.715 | `/home/brandon/Documents/perception-2026-testing/rocklabel/training/experiments/lance-campaign-v1/pointnet-stray/seed-42/pointnet_loro_VolleyBallTest4.reslam_dx-dy-dz/best.pt` |

| rock | intervals | visible returns | model 1 median / best / detected | model 2 median / best / detected | 
|---:|---:|---:|---:|---:|
| 1 | 3 | 165 | 78% / 80% / 3/3 | 82% / 83% / 3/3 | 
| 3 | 3 | 470 | 84% / 91% / 3/3 | 85% / 91% / 3/3 | 
| 4 | 3 | 1158 | 54% / 67% / 2/3 | 43% / 56% / 2/3 | 
| 5 | 2 | 1006 | 83% / 94% / 2/2 | 83% / 94% / 2/2 | 
| 9 | 3 | 439 | 89% / 91% / 3/3 | 91% / 94% / 3/3 | 
| 10 | 2 | 182 | 76% / 89% / 2/2 | 76% / 89% / 2/2 | 
| 11 | 2 | 396 | 66% / 67% / 2/2 | 63% / 67% / 2/2 | 
| 12 | 2 | 362 | 73% / 100% / 2/2 | 67% / 100% / 2/2 | 
| 13 | 3 | 298 | 54% / 59% / 2/3 | 71% / 85% / 2/3 | 

## Automated parity check

**Result: no predeclared material completeness gap was found. This does not prove that the architectures are generally equivalent.**

A material difference was fixed at **20% median rock coverage** before inspecting the selected images. Model 1 leads on 0/9 distinct rocks; model 2 leads on 0/9; 9/9 are within the gap.

- Model 1 coverage leads: `none`
- Model 2 coverage leads: `none`
- Model 1 persistent detection-only rocks: `none`
- Model 2 persistent detection-only rocks: `none`
- Median clear-region positive cells per interval: model 1 `84.0`, model 2 `92.0`
...
- [Rock 4 · interval 31](cases/rock-004-interval-0031.png)
- [Rock 1 · interval 30](cases/rock-001-interval-0030.png)
- [Rock 12 · interval 36](cases/rock-012-interval-0036.png)
- [Rock 9 · interval 49](cases/rock-009-interval-0049.png)
- [Rock 3 · interval 31](cases/rock-003-interval-0031.png)
- [Rock 11 · interval 49](cases/rock-011-interval-0049.png)
- [Rock 5 · interval 2](cases/rock-005-interval-0002.png)
- [Rock 10 · interval 49](cases/rock-010-interval-0049.png)
