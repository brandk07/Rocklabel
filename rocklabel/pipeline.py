...
scan (see :mod:`rocklabel.leveling`). Doing it here rather than in the labeler
...
class LevelledScanStream:
    ...
    :func:`rocklabel.leveling.solve_level`) and applied to the points *and*
...
def ScanStream(mcap_path: str, cfg: dict, stride: int = 1, progress: bool = True,
    ...
    from .leveling import solve_level  # deferred: leveling imports back through us
